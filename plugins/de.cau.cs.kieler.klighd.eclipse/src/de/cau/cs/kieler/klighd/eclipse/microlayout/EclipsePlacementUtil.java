 ...
 */
public final class EclipsePlacementUtil {

    /**
     * Hidden default constructor.
     */
    private EclipsePlacementUtil() {
    }
    ...
    private static FontData fontDataFor(final KText kText, final KGraphElement graphElement) {
        ...
        int fontStyle = kFontBold != null && kFontBold.isBold()
                ? EclipseKlighdConstants.DEFAULT_FONT_STYLE_SWT | SWT.BOLD
    ...
    private static Bounds estimateTextSizeSWT(final FontData fontData,
        ...
        if (Strings.isNullOrEmpty(text)) {
            ...
            textBounds = new Bounds(new java.awt.Point(p.x, p.y));
        ...
        if (!Klighd.isSuppressDisplayScaleCompensationWhileHandlingText()) {
            textBounds.setWidth(textBounds.getWidth() * displayScale.x);
            textBounds.setHeight(textBounds.getHeight() * displayScale.y);
        }
