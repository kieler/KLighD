 ...
 * @author cds
 */
public final class EclipseLabelManagementUtil {
    
    /**
     * This class is not supposed to be instantiated.
     */
    private EclipseLabelManagementUtil() {
    ...
    public static FontData fontDataFor(final ElkLabel label) {
        return EclipsePlacementUtil.fontDataFor(ktextFor(label));
    }
    ...
    public static String findFittingString(final String text, final FontData fontData,
        ...
        Bounds newSize = EclipsePlacementUtil.estimateTextSize(fontData, textWithoutWraps);
        String newText = "";
        ...
        newSize = EclipsePlacementUtil.estimateTextSize(fontData, newText);
        ...
        if (newSize.getWidth() > targetWidth) {
            ...
            while (newSize.getWidth() < targetWidth
                ...
                newSize = EclipsePlacementUtil.estimateTextSize(fontData, newTextCandidate);
    ...
    public static float getWidthOfBiggestWord(final FontData font, final String[] words) {
        Bounds bWSize = EclipsePlacementUtil.estimateTextSize(font, "");
        Bounds textPartSize;

        for (String textpart : words) {
            textPartSize = EclipsePlacementUtil.estimateTextSize(font, textpart);
