 ...
 */
package de.cau.cs.kieler.klighd.examples.circuit.util;
...
public class CircuitAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected CircuitSwitch<Adapter> modelSwitch = new CircuitSwitch<Adapter>() {
        @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.klighd.examples.circuit.Circuit <em>Circuit</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.klighd.examples.circuit.Connector <em>Connector</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.cau.cs.kieler.klighd.examples.circuit.Wire <em>Wire</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
