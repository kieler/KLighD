...
public class KGraphSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case KGraphPackage.IPROPERTY_TO_OBJECT_MAP: {
				@SuppressWarnings("unchecked") Map.Entry<org.eclipse.elk.graph.properties.IProperty<?>, Object> iPropertyToObjectMap = (Map.Entry<org.eclipse.elk.graph.properties.IProperty<?>, Object>)theEObject;
				T result = caseIPropertyToObjectMap(iPropertyToObjectMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KGraphPackage.IPROPERTY_HOLDER: {
				org.eclipse.elk.graph.properties.IPropertyHolder iPropertyHolder = (org.eclipse.elk.graph.properties.IPropertyHolder)theEObject;
	 ...
	 * @generated
	 */
    public T caseIPropertyToObjectMap(Map.Entry<org.eclipse.elk.graph.properties.IProperty<?>, Object> object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseIPropertyHolder(org.eclipse.elk.graph.properties.IPropertyHolder object) {
		return null;
	}
