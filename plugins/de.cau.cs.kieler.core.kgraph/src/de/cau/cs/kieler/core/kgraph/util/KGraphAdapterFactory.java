...
public class KGraphAdapterFactory extends AdapterFactoryImpl {
    ...
    protected KGraphSwitch<Adapter> modelSwitch =
        new KGraphSwitch<Adapter>() {
			...
			@Override
			public Adapter caseIPropertyToObjectMap(Map.Entry<org.eclipse.elk.graph.properties.IProperty<?>, Object> object) {
				return createIPropertyToObjectMapAdapter();
			}
			@Override
			public Adapter caseIPropertyHolder(org.eclipse.elk.graph.properties.IPropertyHolder object) {
