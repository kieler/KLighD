...
public class KGraphFactoryImpl extends EFactoryImpl implements KGraphFactory {
	 ...
	 * @generated
	 */
    public org.eclipse.elk.graph.properties.IProperty<?> createIPropertyFromString(EDataType eDataType, String initialValue) {
		return (org.eclipse.elk.graph.properties.IProperty<?>)super.createFromString(initialValue);
	}
