 ...
 * <!-- end-user-doc -->
 * @see de.cau.cs.kieler.kgraph.text.grandom.GrandomPackage#getFormats()
 * @model
 * @generated
 */
...
{
  /**
   * The '<em><b>Kgt</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #KGT_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Kgx</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #KGX_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Kgt</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Kgt</b></em>' literal object isn't clear,
   ...
   * @ordered
   */
  public static final int KGT_VALUE = 0;

  /**
   * The '<em><b>Kgx</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Kgx</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #KGX
   ...
   * @ordered
   */
  public static final int KGX_VALUE = 1;
  ...
  public static Formats get(int value)
  {
    switch (value)
    {
      case KGT_VALUE: return KGT;
      case KGX_VALUE: return KGX;
    }
    return null;
  }
