...
public class GrandomPackageImpl extends EPackageImpl implements GrandomPackage
{
   ...
   * @see de.cau.cs.kieler.kgraph.text.grandom.GrandomPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static GrandomPackage init()
  {
    ...
    GrandomPackageImpl theGrandomPackage = (GrandomPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GrandomPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GrandomPackageImpl());
  ...
  public void initializePackageContents()
  {
    ...
    addEEnumLiteral(formatsEEnum, Formats.KGT);
    addEEnumLiteral(formatsEEnum, Formats.KGX);
