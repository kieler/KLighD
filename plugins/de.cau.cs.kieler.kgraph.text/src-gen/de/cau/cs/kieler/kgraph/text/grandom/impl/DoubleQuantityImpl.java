 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kgraph.text.grandom.impl.DoubleQuantityImpl#getQuant <em>Quant</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kgraph.text.grandom.impl.DoubleQuantityImpl#getMin <em>Min</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kgraph.text.grandom.impl.DoubleQuantityImpl#isMinMax <em>Min Max</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kgraph.text.grandom.impl.DoubleQuantityImpl#getMax <em>Max</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kgraph.text.grandom.impl.DoubleQuantityImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kgraph.text.grandom.impl.DoubleQuantityImpl#isGaussian <em>Gaussian</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kgraph.text.grandom.impl.DoubleQuantityImpl#getStddv <em>Stddv</em>}</li>
 * </ul>
 *
 * @generated
 */
