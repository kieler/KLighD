...
public class KGraphGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ParentKNodeElements extends AbstractParserRuleElementFinder {
		...
		////----------------- KGraph -----------------
		//ParentKNode KNode:
		//	{KNode} ('kgraph' data+=KIdentifier?)?
		//	data+=KNodeLayout (labels+=KLabel | children+=KNode | ports+=KPort | outgoingEdges+=KEdge
	...
	public class KEdgeElements extends AbstractParserRuleElementFinder {
		...
		//	'->' target=[KNode|QualifiedID] (':' targetPort=[KPort|QualifiedID])? ')' ('{'
	...
	public class KNodeLayoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.kgraph.text.KGraph.KNodeLayout");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EmptyKNodeLayoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.kgraph.text.KGraph.EmptyKNodeLayout");
	...
	public class KShapeLayoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.kgraph.text.KGraph.KShapeLayout");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//KShapeLayout:
		//	{KShapeLayout} (('pos' ':' (('x' '=' xpos=Float)? & ('y' '=' ypos=Float)?))?
		//	& ('size' ':' (('width' '=' width=Float)? & ('height' '=' height=Float)?))?
		//	& ('properties' ':' persistentEntries+=Property*)?);
		@Override public ParserRule getRule() { return rule; }
	...
	public class EmptyKShapeLayoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.kgraph.text.KGraph.EmptyKShapeLayout");
		private final Action cKShapeLayoutAction = (Action)rule.eContents().get(1);
		
		//EmptyKShapeLayout KShapeLayout:
		//	{KShapeLayout}
		@Override public ParserRule getRule() { return rule; }
	...
	public class KEdgeLayoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.kgraph.text.KGraph.KEdgeLayout");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EmptyKEdgeLayoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.kgraph.text.KGraph.EmptyKEdgeLayout");
		private final Group cGroup = (Group)rule.eContents().get(1);
