 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.core.krendering.KYPosition#getAbsolute <em>Absolute</em>}</li>
 *   <li>{@link de.cau.cs.kieler.core.krendering.KYPosition#getRelative <em>Relative</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.cau.cs.kieler.core.krendering.KRenderingPackage#getKYPosition()
 * @model abstract="true"
 * @generated
 */
public interface KYPosition<T extends KYPosition<T>> extends EObject {
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.core.krendering.KYPosition#getAbsolute <em>Absolute</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.core.krendering.KYPosition#getRelative <em>Relative</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * Redirects to {@link de.cau.cs.kieler.core.krendering.KRenderingUtil#setPosition(KYPosition, float, float) KRenderingUtil.setPosition(KYPosition, float, float)}.
