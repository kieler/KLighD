 ...
 * <ul>
 *   <li>{@link krendering.KPosition#getX <em>X</em>}</li>
 *   <li>{@link krendering.KPosition#getY <em>Y</em>}</li>
 * </ul>
 * </p>
 *
 * @see krendering.KRenderingPackage#getKPosition()
 * @model
 * @generated
 */
public interface KPosition extends EObject {
     ...
     * @see #setX(KXPosition)
     * @see krendering.KRenderingPackage#getKPosition_X()
    ...
    /**
     * Sets the value of the '{@link krendering.KPosition#getX <em>X</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setY(KYPosition)
     * @see krendering.KRenderingPackage#getKPosition_Y()
     * @model containment="true" required="true"
     * @generated
     */
    KYPosition getY();
    ...
    /**
     * Sets the value of the '{@link krendering.KPosition#getY <em>Y</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
