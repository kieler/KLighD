 ...
 * <ul>
 *   <li>{@link krendering.KStyle#getRendering <em>Rendering</em>}</li>
 *   <li>{@link krendering.KStyle#isPropagateToChildren <em>Propagate To Children</em>}</li>
 * </ul>
 * </p>
 *
 * @see krendering.KRenderingPackage#getKStyle()
 * @model
 * @generated
 */
public interface KStyle extends EObject {
     ...
     * It is bidirectional and its opposite is '{@link krendering.KRendering#getStyles <em>Styles</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see krendering.KRenderingPackage#getKStyle_Rendering()
    ...
    /**
     * Sets the value of the '{@link krendering.KStyle#getRendering <em>Rendering</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see krendering.KRenderingPackage#getKStyle_PropagateToChildren()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link krendering.KStyle#isPropagateToChildren <em>Propagate To Children</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
