...
public interface KPosition extends EObject {
     ...
     * @see #setX(KXPosition)
     * @see de.cau.cs.kieler.klighd.krendering.KRenderingPackage#getKPosition_X()
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.klighd.krendering.KPosition#getX <em>X</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setY(KYPosition)
     * @see de.cau.cs.kieler.klighd.krendering.KRenderingPackage#getKPosition_Y()
     * @model containment="true" required="true"
     * @generated
     */
    KYPosition<?> getY();
    ...
    /**
     * Sets the value of the '{@link de.cau.cs.kieler.klighd.krendering.KPosition#getY <em>Y</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * <!-- end-model-doc -->
     * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='return de.cau.cs.kieler.klighd.krendering.KRenderingUtil.setPositions(this, x, y);'"
     * @generated
     */
