		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getKNodeAccess().getGroup_7_3(), "rule__KNode__Group_7_3__0");
					put(grammarAccess.getKNodeAccess().getGroup_8(), "rule__KNode__Group_8__0");
					put(grammarAccess.getKNodeAccess().getGroup_8_3(), "rule__KNode__Group_8_3__0");
					...
					put(grammarAccess.getKLabelAccess().getGroup_4_3(), "rule__KLabel__Group_4_3__0");
					...
					put(grammarAccess.getKRenderingLibraryAccess().getGroup_3_3(), "rule__KRenderingLibrary__Group_3_3__0");
					...
					put(grammarAccess.getKStyle_ImplAccess().getGroup(), "rule__KStyle_Impl__Group__0");
					...
					put(grammarAccess.getKEllipseAccess().getGroup_5_3(), "rule__KEllipse__Group_5_3__0");
					...
					put(grammarAccess.getKEllipseAccess().getGroup_7(), "rule__KEllipse__Group_7__0");
					...
					put(grammarAccess.getKRectangleAccess().getGroup_5_3(), "rule__KRectangle__Group_5_3__0");
					...
					put(grammarAccess.getKRectangleAccess().getGroup_7(), "rule__KRectangle__Group_7__0");
					...
					put(grammarAccess.getKRoundedRectangleAccess().getGroup_7(), "rule__KRoundedRectangle__Group_7__0");
					put(grammarAccess.getKRoundedRectangleAccess().getGroup_8(), "rule__KRoundedRectangle__Group_8__0");
					put(grammarAccess.getKRoundedRectangleAccess().getGroup_8_3(), "rule__KRoundedRectangle__Group_8_3__0");
					put(grammarAccess.getKRoundedRectangleAccess().getGroup_9(), "rule__KRoundedRectangle__Group_9__0");
					put(grammarAccess.getKRoundedRectangleAccess().getGroup_9_3(), "rule__KRoundedRectangle__Group_9_3__0");
					put(grammarAccess.getKRoundedRectangleAccess().getGroup_10(), "rule__KRoundedRectangle__Group_10__0");
					...
					put(grammarAccess.getKPolyline_ImplAccess().getGroup_5_3(), "rule__KPolyline_Impl__Group_5_3__0");
					...
					put(grammarAccess.getKPolyline_ImplAccess().getGroup_7(), "rule__KPolyline_Impl__Group_7__0");
					...
					put(grammarAccess.getKPolygonAccess().getGroup_5_3(), "rule__KPolygon__Group_5_3__0");
					...
					put(grammarAccess.getKPolygonAccess().getGroup_7(), "rule__KPolygon__Group_7__0");
					...
					put(grammarAccess.getKEdgeLayoutAccess().getGroup_2_3(), "rule__KEdgeLayout__Group_2_3__0");
					...
					put(grammarAccess.getKPointAccess().getGroup_4(), "rule__KPoint__Group_4__0");
					put(grammarAccess.getKNodeAccess().getIncomingEdgesAssignment_3_2(), "rule__KNode__IncomingEdgesAssignment_3_2");
					put(grammarAccess.getKNodeAccess().getIncomingEdgesAssignment_3_3_1(), "rule__KNode__IncomingEdgesAssignment_3_3_1");
					...
					put(grammarAccess.getKNodeAccess().getPortsAssignment_7_2(), "rule__KNode__PortsAssignment_7_2");
					put(grammarAccess.getKNodeAccess().getPortsAssignment_7_3_1(), "rule__KNode__PortsAssignment_7_3_1");
					put(grammarAccess.getKNodeAccess().getOutgoingEdgesAssignment_8_2(), "rule__KNode__OutgoingEdgesAssignment_8_2");
					put(grammarAccess.getKNodeAccess().getOutgoingEdgesAssignment_8_3_1(), "rule__KNode__OutgoingEdgesAssignment_8_3_1");
					...
					put(grammarAccess.getKLabelAccess().getDataAssignment_4_3_1(), "rule__KLabel__DataAssignment_4_3_1");
					...
					put(grammarAccess.getKEdgeAccess().getTargetAssignment_3(), "rule__KEdge__TargetAssignment_3");
					...
					put(grammarAccess.getKRenderingLibraryAccess().getRenderingsAssignment_3_2(), "rule__KRenderingLibrary__RenderingsAssignment_3_2");
					put(grammarAccess.getKRenderingLibraryAccess().getRenderingsAssignment_3_3_1(), "rule__KRenderingLibrary__RenderingsAssignment_3_3_1");
					...
					put(grammarAccess.getKStyle_ImplAccess().getPropagateToChildrenAssignment_0(), "rule__KStyle_Impl__PropagateToChildrenAssignment_0");
					put(grammarAccess.getKEllipseAccess().getReferencesAssignment_3_2(), "rule__KEllipse__ReferencesAssignment_3_2");
					put(grammarAccess.getKEllipseAccess().getReferencesAssignment_3_3_1(), "rule__KEllipse__ReferencesAssignment_3_3_1");
					put(grammarAccess.getKEllipseAccess().getPlacementDataAssignment_4_1(), "rule__KEllipse__PlacementDataAssignment_4_1");
					put(grammarAccess.getKEllipseAccess().getStylesAssignment_5_2(), "rule__KEllipse__StylesAssignment_5_2");
					put(grammarAccess.getKEllipseAccess().getStylesAssignment_5_3_1(), "rule__KEllipse__StylesAssignment_5_3_1");
					...
					put(grammarAccess.getKEllipseAccess().getChildPlacementAssignment_7_1(), "rule__KEllipse__ChildPlacementAssignment_7_1");
					put(grammarAccess.getKRectangleAccess().getReferencesAssignment_3_2(), "rule__KRectangle__ReferencesAssignment_3_2");
					put(grammarAccess.getKRectangleAccess().getReferencesAssignment_3_3_1(), "rule__KRectangle__ReferencesAssignment_3_3_1");
					put(grammarAccess.getKRectangleAccess().getPlacementDataAssignment_4_1(), "rule__KRectangle__PlacementDataAssignment_4_1");
					put(grammarAccess.getKRectangleAccess().getStylesAssignment_5_2(), "rule__KRectangle__StylesAssignment_5_2");
					put(grammarAccess.getKRectangleAccess().getStylesAssignment_5_3_1(), "rule__KRectangle__StylesAssignment_5_3_1");
					...
					put(grammarAccess.getKRectangleAccess().getChildPlacementAssignment_7_1(), "rule__KRectangle__ChildPlacementAssignment_7_1");
					put(grammarAccess.getKRoundedRectangleAccess().getCornerWidthAssignment_3(), "rule__KRoundedRectangle__CornerWidthAssignment_3");
					put(grammarAccess.getKRoundedRectangleAccess().getCornerHeightAssignment_5(), "rule__KRoundedRectangle__CornerHeightAssignment_5");
					put(grammarAccess.getKRoundedRectangleAccess().getReferencesAssignment_6_2(), "rule__KRoundedRectangle__ReferencesAssignment_6_2");
					put(grammarAccess.getKRoundedRectangleAccess().getReferencesAssignment_6_3_1(), "rule__KRoundedRectangle__ReferencesAssignment_6_3_1");
					put(grammarAccess.getKRoundedRectangleAccess().getPlacementDataAssignment_7_1(), "rule__KRoundedRectangle__PlacementDataAssignment_7_1");
					put(grammarAccess.getKRoundedRectangleAccess().getStylesAssignment_8_2(), "rule__KRoundedRectangle__StylesAssignment_8_2");
					put(grammarAccess.getKRoundedRectangleAccess().getStylesAssignment_8_3_1(), "rule__KRoundedRectangle__StylesAssignment_8_3_1");
					put(grammarAccess.getKRoundedRectangleAccess().getChildrenAssignment_9_2(), "rule__KRoundedRectangle__ChildrenAssignment_9_2");
					put(grammarAccess.getKRoundedRectangleAccess().getChildrenAssignment_9_3_1(), "rule__KRoundedRectangle__ChildrenAssignment_9_3_1");
					put(grammarAccess.getKRoundedRectangleAccess().getChildPlacementAssignment_10_1(), "rule__KRoundedRectangle__ChildPlacementAssignment_10_1");
					put(grammarAccess.getKPolyline_ImplAccess().getReferencesAssignment_3_2(), "rule__KPolyline_Impl__ReferencesAssignment_3_2");
					put(grammarAccess.getKPolyline_ImplAccess().getReferencesAssignment_3_3_1(), "rule__KPolyline_Impl__ReferencesAssignment_3_3_1");
					put(grammarAccess.getKPolyline_ImplAccess().getPlacementDataAssignment_4_1(), "rule__KPolyline_Impl__PlacementDataAssignment_4_1");
					put(grammarAccess.getKPolyline_ImplAccess().getStylesAssignment_5_2(), "rule__KPolyline_Impl__StylesAssignment_5_2");
					put(grammarAccess.getKPolyline_ImplAccess().getStylesAssignment_5_3_1(), "rule__KPolyline_Impl__StylesAssignment_5_3_1");
					...
					put(grammarAccess.getKPolyline_ImplAccess().getChildPlacementAssignment_7_1(), "rule__KPolyline_Impl__ChildPlacementAssignment_7_1");
					put(grammarAccess.getKPolygonAccess().getReferencesAssignment_3_2(), "rule__KPolygon__ReferencesAssignment_3_2");
					put(grammarAccess.getKPolygonAccess().getReferencesAssignment_3_3_1(), "rule__KPolygon__ReferencesAssignment_3_3_1");
					put(grammarAccess.getKPolygonAccess().getPlacementDataAssignment_4_1(), "rule__KPolygon__PlacementDataAssignment_4_1");
					put(grammarAccess.getKPolygonAccess().getStylesAssignment_5_2(), "rule__KPolygon__StylesAssignment_5_2");
					put(grammarAccess.getKPolygonAccess().getStylesAssignment_5_3_1(), "rule__KPolygon__StylesAssignment_5_3_1");
					...
					put(grammarAccess.getKPolygonAccess().getChildPlacementAssignment_7_1(), "rule__KPolygon__ChildPlacementAssignment_7_1");
					...
					put(grammarAccess.getKForegroundColorAccess().getPropagateToChildrenAssignment_0(), "rule__KForegroundColor__PropagateToChildrenAssignment_0");
					put(grammarAccess.getKForegroundColorAccess().getRedAssignment_4(), "rule__KForegroundColor__RedAssignment_4");
					put(grammarAccess.getKForegroundColorAccess().getGreenAssignment_6(), "rule__KForegroundColor__GreenAssignment_6");
					put(grammarAccess.getKForegroundColorAccess().getBlueAssignment_8(), "rule__KForegroundColor__BlueAssignment_8");
					put(grammarAccess.getKBackgroundColorAccess().getPropagateToChildrenAssignment_0(), "rule__KBackgroundColor__PropagateToChildrenAssignment_0");
					put(grammarAccess.getKBackgroundColorAccess().getRedAssignment_4(), "rule__KBackgroundColor__RedAssignment_4");
					put(grammarAccess.getKBackgroundColorAccess().getGreenAssignment_6(), "rule__KBackgroundColor__GreenAssignment_6");
					put(grammarAccess.getKBackgroundColorAccess().getBlueAssignment_8(), "rule__KBackgroundColor__BlueAssignment_8");
					...
					put(grammarAccess.getKVisibilityAccess().getPropagateToChildrenAssignment_0(), "rule__KVisibility__PropagateToChildrenAssignment_0");
					put(grammarAccess.getKVisibilityAccess().getLineVisibleAssignment_1(), "rule__KVisibility__LineVisibleAssignment_1");
					put(grammarAccess.getKVisibilityAccess().getFilledAssignment_2(), "rule__KVisibility__FilledAssignment_2");
					...
					put(grammarAccess.getKGridPlacementAccess().getNumColumnsAssignment_3(), "rule__KGridPlacement__NumColumnsAssignment_3");
					...
					put(grammarAccess.getKEdgeLayoutAccess().getBendPointsAssignment_2_2(), "rule__KEdgeLayout__BendPointsAssignment_2_2");
					put(grammarAccess.getKEdgeLayoutAccess().getBendPointsAssignment_2_3_1(), "rule__KEdgeLayout__BendPointsAssignment_2_3_1");
					put(grammarAccess.getKEdgeLayoutAccess().getSourcePointAssignment_4(), "rule__KEdgeLayout__SourcePointAssignment_4");
					put(grammarAccess.getKEdgeLayoutAccess().getTargetPointAssignment_6(), "rule__KEdgeLayout__TargetPointAssignment_6");
					put(grammarAccess.getKPointAccess().getXAssignment_3_1(), "rule__KPoint__XAssignment_3_1");
					put(grammarAccess.getKPointAccess().getYAssignment_4_1(), "rule__KPoint__YAssignment_4_1");
				}
			};
		}
