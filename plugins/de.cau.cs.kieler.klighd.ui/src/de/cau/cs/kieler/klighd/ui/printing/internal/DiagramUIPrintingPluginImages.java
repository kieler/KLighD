...
public class DiagramUIPrintingPluginImages {
    ...
    public static final ImageDescriptor DESC_UP = create(PREFIX_ENABLED + "print_preview_up.gif"); //$NON-NLS-1$
    ...
    public static final ImageDescriptor COLLATE_ON = create(PREFIX_ENABLED + "collate.gif"); //$NON-NLS-1$

    public static final ImageDescriptor COLLATE_OFF = create(PREFIX_ENABLED + "no_collate.gif"); //$NON-NLS-1$
