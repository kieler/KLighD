...
/**
 * Interface for exporter for a {@link de.cau.cs.kieler.klighd.piccolo.viewer.PiccoloViewer
 * PiccoloViewer}. This might result in a .png or .svg, for instance.
 * 
 * @author uru
 * 
...
public interface IViewExporter {
     ...
     * of the {@link IViewExporter} interface might support multiple sub formats of the same parent
