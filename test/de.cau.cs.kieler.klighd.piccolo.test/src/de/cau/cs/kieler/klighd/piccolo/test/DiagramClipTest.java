...
public class DiagramClipTest {
    ...
    public void test() throws InterruptedException {
        ...
        if (FINISH == inputParam) {
            ...
            Assert.assertThat(Pair.of(((IEclipseViewer) viewer).getControl(), port0pos), IS_BLACK);

            waitAmoment();

            moveTo((int) (portXpos.x), (int) (portXpos.y));
            Assert.assertThat(Pair.of(((IEclipseViewer) viewer).getControl(), portXpos), IS_BLACK);
        }
    }
